...
public static partial class AppGenerator
{
    ...
    /// </summary>
    internal static Dictionary<int, MessageTemplateViewModel> Messages = [];
        ...
        this WebApplicationBuilder? builder, IConfiguration? configuration, string? appRoot)
    {
        ...
        application.MapAssets();

        application.MapRouting(configuration);
    ...
    /// <param name="configuration"></param>
    /// <returns></returns>
    public static WebApplication? MapAssets(this WebApplication? application)
    {
    ...
    /// <param name="configuration"></param>
    /// <returns></returns>
    public static WebApplication? MapRouting(this WebApplication? application, IConfiguration? configuration)
    {
        application?.MapControllerRoute(
            name: "Home", pattern: "{controller=Home}/{action=Index}/{id?}");
    ...
    /// </summary>
    /// <returns></returns>
    internal static MessageTemplateViewModel GetCurrentMessage(int index)
    {
        if ((Messages.Count == 0) || (index < 0) || (index >= Messages.Count))
            return new MessageTemplateViewModel(string.Empty, MessageTemplateType.Error);
    ...
    /// <returns></returns>
    internal static string GetMessageStyle(MessageTemplateViewModel template)
    {
